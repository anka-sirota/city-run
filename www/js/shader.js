/* -------------------------------------------------------------------------
//	Normal map shader with separate offsetRepeat for maps
//		- Blinn-Phong
...
var shader = {
    ...
    uniforms: THREE.UniformsUtils.merge( [
        ...
        "offsetRepeatDiffuse" : { type: "v4", value: new THREE.Vector4( 0, 0, 1, 1 ) },
        "offsetRepeatNormal" : { type: "v4", value: new THREE.Vector4( 0, 0, 1, 1 ) },
        "offsetRepeatSpecular" : { type: "v4", value: new THREE.Vector4( 0, 0, 1, 1 ) },
    ...
    fragmentShader: [
        ...
        "uniform vec4 offsetRepeatDiffuse;",
        "uniform vec4 offsetRepeatNormal;",
        "uniform vec4 offsetRepeatSpecular;",
        ...
        "void main() {",
            ...
            "if( enableSpecular ) {",
                "specularTex = texture2D( tSpecular, vUv * offsetRepeatSpecular.zw).xyz;",
...
THREE.ShaderLib["normalmap_"] = shader;
